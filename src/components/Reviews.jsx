    ...
    return(
        ...
        <body className='gridplace-items-center grid grid-cols-1 md:grid-cols-2 rounded-3xl'>
            <div className='flex flex-col p-10 gap-10 gap-4'>
                ...
                <figure className='bg-white rounded-2xl border-2 shadow-lg overflow-hidden rotate-1 hover:rotate-0 transition duration-200'>
...
<div className='flex flex-col p-10 gap-10 gap-4'>
                <figure className='bg-white rounded-2xl shadow-lg border-2 overflow-hidden -rotate-2 hover:-rotate-1 transition duration-200'>
                    <blockquote className='p-8'>
                ...
                <div className='flex flex-col p-10 gap-10 gap-4'>
                <figure className='bg-white rounded-2xl shadow-lg border-2 overflow-hidden rotate-1 hover:-rotate-1 transition duration-200'>
                    <blockquote className='p-8'>
                        <div className='mb-5 text-blue-100'>
                        <svg width="45" height="36" class="fill-current"><path d="M13.415.001C6.07 5.185.887 13.681.887 23.041c0 7.632 4.608 12.096 9.936 12.096 5.04 0 8.784-4.032 8.784-8.784 0-4.752-3.312-8.208-7.632-8.208-.864 0-2.016.144-2.304.288.72-4.896 5.328-10.656 9.936-13.536L13.415.001zm24.768 0c-7.2 5.184-12.384 13.68-12.384 23.04 0 7.632 4.608 12.096 9.936 12.096 4.896 0 8.784-4.032 8.784-8.784 0-4.752-3.456-8.208-7.776-8.208-.864 0-1.872.144-2.16.288.72-4.896 5.184-10.656 9.792-13.536L38.183.001z"></path></svg>
                        ...
                        <p className='font-bold text-lg'>
                        Oscar was amazing! I can't say enough good things about this hard working young man. He was professional and has a strong work ethic. If I EVER need anything painted I'm calling him!
                         </p>
                    </blockquote>
                    <div className='flex inset-x-0 bottom-0 items-center justify-between px-10 py-5 bg-gradient-to-r from-indigo-600 via-violet-700 to-indigo-600
                    to-indigo-500'>
                ...
                <figure className='bg-white rounded-2xl shadow-lg border-2 overflow-hidden -rotate-2 hover:-rotate-1 transition duration-200'>
                    <blockquote className='p-8'>
                        ...
                        <p className='font-bold text-lg'>
                        Flow paint did an excellent job painting my home. I highly recommend them. The work was beautifully done. It was done in a timely manner. The clean up was great. The entire experience was professional and the value was excellent.
                         </p>
                    </blockquote>
                    <div className='flex inset-x-0 bottom-0 items-center justify-between px-10 py-5 bg-orange-500'>
                        <div className='flex items-center gap-5'>
                            <figcaption className='text-white font-semibold'>
                                <div>- Eileen A.</div>
                                <div className='opactiy-70 '></div>
